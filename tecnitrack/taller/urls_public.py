"""
OrdenTec - URLs publicas (schema public): landing, registro, seguimiento
"""
...
urlpatterns = [
    ...
    # Una sola URL persistente para todo el wizard
    path('registro/continuar/<str:token>/', onb.continuar_registro, name='continuar_registro'),
